...
resource "aws_iam_role" "poc_codebuild_role" {
  name               = "codebuild-role"
...
resource "aws_iam_role_policy_attachment" "s3_full_access" {
  role       = aws_iam_role.poc_codebuild_role.name
